...
\begin{figure}
    \centering
    \subfloat[]{\includegraphics[width = 0.45\textwidth]{immagini/WD1.jpg}} \qquad
    \subfloat[]{\includegraphics[width = 0.45\textwidth]{immagini/WD2.jpg}}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.5\textwidth]{immagini/onion.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.4\textwidth]{immagini/supernova.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = \textwidth]{immagini/stretch_hammuy.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{immagini/blackhole.jpg}
