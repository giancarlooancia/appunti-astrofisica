...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{immagini/classificazione-di-hubble.jpg}
...
\begin{figure}
	\centering
	\includegraphics[width = \textwidth]{immagini/galassie-colore-magnitudine.jpg}
...
\begin{figure}
	\centering
	\includegraphics[width = 0.6 \textwidth ]{immagini/galassie-colore-massa-stellare.jpg}
...
\begin{figure}
	\centering
	\includegraphics[width = 0.5\textwidth]{immagini/non-omogeneita-universo.jpg}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width = 0.5\textwidth]{immagini/enviromental-density.jpg}
