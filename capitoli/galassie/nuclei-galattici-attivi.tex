...
\begin{figure}
    \centering
    \includegraphics[width = 0.6\textwidth]{immagini/hercules-a.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.8 \textwidth]{immagini/galassie-radio.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = \textwidth]{immagini/sezione-e-anatomia-agn.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = \textwidth]{immagini/modello-unificazione-agn.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.7 \textwidth]{immagini/compattezza-agn.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.8 \textwidth]{immagini/sed-agn.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = \textwidth]{immagini/emissione-del-disco-di-accrescimento.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.7\textwidth]{immagini/xrb-agn.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.6 \textwidth]{immagini/coevolution-galassie-agn.jpg}
