\section{Classificazione di Hubble}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{classificazione di Hubble.png}
...
\begin{figure}
    \centering
    \includegraphics[width = \textwidth]{Galassie (colore e magnitudine).png}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.6 \textwidth ]{Galassie (colore e massa stellare).png}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.5\textwidth]{Non omogeneitÃ  dell'universo.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width = 0.5\textwidth]{Enviromental density.png}
