...
\begin{figure}
    \centering
    \includegraphics[width = 0.4 \textwidth]{immagini/effetto-doppler.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.4 \textwidth]{immagini/potenziale-galassie-a-spirale.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width= 0.5\textwidth]{immagini/confronto-curve-di-rotazione.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width =0.7\textwidth]{immagini/spettroscopia-fessura-campo-integrale.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.5\textwidth]{immagini/schiacciamento-galassie.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{immagini/gravitational-lensing.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.8 \textwidth]{immagini/materia-oscura-ellittiche.jpg}
