...
\begin{figure}
    \centering
    \includegraphics[width = 0.4 \textwidth]{effetto doppler.png}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.5 \textwidth]{Potenziale galassie a spirale.png}
