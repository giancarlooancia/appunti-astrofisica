...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{immagini/classificazione-spettrale-stelle.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{immagini/classificazione-spettrale-stelle-2.jpg}
    \caption{Classi spettrali principali.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{immagini/righe-spettrali.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{immagini/curva-crescita.jpg}
...
\subfloat[][\emph{Regime lineare}\label{fig:larghezza-equivalente-regime-lineare}]
    {\includegraphics[width=0.45\textwidth]{immagini/larghezza-equivalente-regime-lineare.jpg}} \quad
\subfloat[][\emph{Regime piatto o di saturazione}\label{fig:larghezza-equivalente-regime-piatto}]
    {\includegraphics[width=0.45\textwidth]{immagini/larghezza-equivalente-regime-piatto.jpg}} \quad
\subfloat[][\emph{Regime di smorzamento}\label{fig:larghezza-equivalente-regime-smorzamento}]
    {\includegraphics[width=0.45\textwidth]{immagini/larghezza-equivalente-regime-smorzamento.jpg}}
