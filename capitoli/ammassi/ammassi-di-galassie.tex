...
Il numero di galassie contenute è notevolmente maggiore al caso dei gruppi galattici, infatti contano circa $100$/$1000$ elementi. Le galassie contenute sono principalmente ellittiche e l’estensione radiale è compresa fra $1$ e $10$ $\si{Mpc}$.
...
Una particolarità degli ammassi è che spesso, nel centro di essi, è presente una galassia molto massiccia e luminosa, detta “Brightest Cluster Galaxy” o “BCG” (si veda par.~\ref{sec:brightest-cluster-galaxy}).
...
Infine, è importante notare che, nonostante gli ammassi siano formati principalmente da galassie, la materia galattica costituisce solo il $5\%$ della massa complessiva di essi, il gas caldo diffuso presente (par.~\ref{sec:intra-cluster-medium}) ne costituisce il $15\%$, mentre il restante $80\%$ è opera della materia oscura.
...
Comparando le immagini~\ref{fig:visible-icm} e~\ref{fig:X-icm}, le quali raffigurano uno stesso ammasso rispettivamente nel visibile e in banda X, si noti come l'ICM sia visibile solo tramite osservazioni in banda X.
...
La metallicità dell’ICM è particolarmente elevata, è circa pari al $30\%$ di quella solare e questo indica il fatto che non si tratta di un gas primordiale, ma di un composto arricchito da precedenti fenomeni astrofisici.

\begin{figure}
    \centering
    \subfloat[][\emph{Osservato nel visibile.}\label{fig:visible-icm}]
    {\includegraphics[width=.45\textwidth]{immagini/visible-icm.png}} \quad
    \subfloat[][\emph{Osservato in banda X, in blu l'ICM.}\label{fig:X-icm}]
    {\includegraphics[width=.45\textwidth]{immagini/icm.png}}
    \caption{Osservazione dell'ammasso MACS J$1149.6+2223$ in due bande diverse.}
    \label{fig:subfig-icm}
\end{figure}
...
Partendo dall’equazione di equilibrio idrostatico in un potenziale sferico: 
\begin{equation} 
