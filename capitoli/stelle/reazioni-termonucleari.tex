...
\reaction[re:decadimento-beta-]{n -> p^+ + e^- + $\bar{\nu}$}
...
\reaction[re:cno6]{N^{15} + H^1 -> C^{12} + He^4}
...
\[
M_G \sim \SI{e12}{\solarmass} \qquad L_G \sim \SI{e11}{\solarluminosity}
\]
...
In definitiva \ce{3 He^4} vengono trasformati in un \ce{C^12}. Facendo un computo dell'energia si trova:
