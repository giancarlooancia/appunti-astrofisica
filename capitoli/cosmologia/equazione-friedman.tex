...
L'equazione~\refeq{eq:friedman}, può essere anche espressa combinandola con la (\refeq{eq:hubble-scale}) esprimendola come funzione del parametro di Hubble, $H$.
...
\end{equation}
utilizzando la quale è possibile riscrivere l'equazione~\refeq{eq:friedman}
